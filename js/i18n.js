...
const STRINGS = {
  fr: {
    ...
    'rules.overview.diagram.npcZone': 'PNJ',
    'rules.overview.diagram.you': 'Vous',
    ...
    'rules.specialPaths.cashoutDesc': "Banque l'or de la partie dans votre or permanent, la partie continue.",
  ...
  en: {
    ...
    'rules.overview.diagram.npcZone': 'NPCs',
    'rules.overview.diagram.you': 'You',
    ...
    'rules.specialPaths.cashoutDesc': "Banks the run's gold into your permanent gold, the run continues.",
